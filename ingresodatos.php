        ...
        <center>
            <table border="2" style="width:90%;text-align:center;">
                ...
                <tr>
                    ...
                    <td><input type="number" min="1" step="1" max="10000" id="clientesesp" name="Numero_total_clientes_Xdia" pattern="[0-9]"><br>
                        <p id="minMessage">Tienes que escribir algo bro</p>
                    </td>
                    <input type="hidden" id="Num_periodos_tiempo" name="Num_periodos_tiempo" value="<?php echo $_SESSION["periodos"]; ?>">
        ...
        <center>
            <table border="2" style="width:90%;text-align:center;">
                ...
                <tr>
                    ...
                    <td><input type="number" min="0" id="minimos" name="Cantidad_min_productos_Xclientes" step="1" pattern="[0-9]"><br>
                        <p id="minMessage">Tienes que escribir algo bro</p>
                    </td>
                    <td><input type="number" min="1" max="1000" id="maximos" name="Cantidad_max_productos_Xclientes" step="1" pattern="[0-9]"><br>
                        <p id="minMessage">Tienes que escribir algo bro</p>
                    </td>
                    <td><input type="number" min="0.1" max="3600" id="productos" name="Tiempo_promedio_seleccion_Xproducto" step="0.1"><br>
                        <p id="minMessage">Tienes que escribir algo bro</p>
                    </td>
                    <td><input type="number" min="0.1" max="3600" id="marcado" name="Tiempo_promedio_despacho_Xproducto" step="0.1"><br>
                        <p id="minMessage">Tienes que escribir algo bro</p>
                    </td>
        ...
        <center>
            <table border="2" style="width:22.5%;text-align:center;">
                ...
                <tr>
                    ...
                    <td><input type="number" min="0.1" max="3600" id="pago" name="Tiempo_promedio_pago" step="0.1"><br>
                        <p id="minMessage">Tienes que escribir algo bro</p>
                    </td>
            ...
            <table border="2" id="tabla_intervalos" style="width:67.5%;text-align:center;">
                ...
                ?>
                    <tr id="tr_inputs<?php echo $i ?>">
                        ...
                        <td><input type="number" min="0" max="100" id="distribucion<?php echo $i; ?>" name="distribucion<?php echo $i; ?>" step="0.1"><br>
                            <p id="minMessage">Tienes que escribir algo bro</p>
                        </td>
                        <td><input type="number" min="1" max="100" id="cajas<?php echo $i; ?>" name="cajas<?php echo $i; ?>" step="1" pattern="[0-9]"><br>
                            <p id="minMessage">Tienes que escribir algo bro</p>
                        </td>
...
<script>
    let contadorIntervalos = parseInt(document.getElementById("Num_periodos_tiempo").value);
    $(document).ready(function() {
        $('#enviar').click(function() {
